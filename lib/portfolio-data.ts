...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "An AI-powered Palantir Foundry application that expedites defense sourcing workflows by scoring dual-use commercial replacements for military-grade components.",
    longDescription: [
