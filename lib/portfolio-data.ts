...
export const projects: Project[] = [
  {
    ...
    description:
      "Designing and modeling a bio-inspired wing morphing structure using Grasshopper and Rhino for powder-based 3D printing.",
    longDescription: [
  ...
  },
  {
    ...
    longDescription: [
      ...
      "To close the procurement loop, the platform equips sourcing officers with an actionable dashboard powered by AIP. The AI agent automatically summarizes viable replacements, evaluates engineering trade-offs, and executes a guided 3-step workflow to draft and send vendor communications, reducing sourcing timelines from weeks to minutes.",
    ],
    tags: ["Foundry", "AIP", "Data Ontology", "API Integration"],
    ...
    featured: true,
    outcomes: [
      "Engineered a Foundry data ontology joining 41 National Stock Numbers (NSNs) with over 1,000 commercial candidates from DigiKey and Nexar/Octopart APIs.",
    ...
    links: [
      {
        ...
        url: "https://docs.google.com/presentation/d/1bWfdk4ToIZ80w7iqfrqumaj9P4C3WKRHzm47_HKVHjI/edit?usp=sharing",
      },
      {
        label: "GitHub Repository",
        url: "https://github.com/sunya-afrasiabi/sunya-afrasiabi-portfolio",
      },
      {
        label: "Watch Demo Video",
        url: "https://www.youtube.com/watch?v=Tlzn4IAGWmQ",
      },
    ],
  },
  {
    ...
    description:
      "Iterative thermodynamic modeling and experimental calibration of a variable-mass water rocket for precise spatial target acquisition.",
    longDescription: [
    ...
    links: [
      {
        label: "Google Colab Codebase",
        url: "https://colab.research.google.com/drive/1Ibv-5OsyrvuQJYkHpkiBurK4cnaGsRCC?usp=sharing",
      },
      {
        label: "Calibration Logs",
        url: "https://docs.google.com/spreadsheets/d/1GZ_oA8uZZpWpOq7V8PbKMCz3gbvjFobtUqlkufEcfhU/edit?usp=sharing",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "Led the radiation research effort as radiation subteam lead for our team's proposed lunar technology, contributing to technical research, systems engineering, proposal development, and NASA-style peer proposal evaluation.",
    longDescription: [
...
export const writing: Writing[] = [
  {
    ...
    date: "August 2025",
    excerpt:
      "An expository research paper linking advanced linear algebra concepts to neural network architectures, training algorithms, and real-world robotics applications. Written for MATH 3120, a theory-based linear algebra course.",
    pdfUrl:
      "https://drive.google.com/file/d/1qKJMd1UthNnXQKS5OtD8bKFdRR9bpLSl/preview",
    tag: "Research",
    featured: true,
  },
  {
    ...
    date: "May 2025",
    excerpt:
      "Investor-oriented whitepaper on UAVs, AI wildfire prediction, and aerospace innovations, framing $6.4B+ market opportunities and potential $5B annual cost savings. Co-authored as part of Wharton Undergraduate Aerospace Club.",
    pdfUrl:
      "https://drive.google.com/file/d/1mxdoEXoXRByKiuIf6_fvRVWCfc1j1aYx/preview",
    tag: "Whitepaper",
    featured: true,
  },
  {
    ...
    date: "July 2026",
    excerpt:
      "A philosophy paper written to examine the ethics of AI companion platforms, arguing that current designs profit by intentionally cultivating emotional dependency. Written for PHIL 1330, an ethics course.",
    pdfUrl:
      "https://drive.google.com/file/d/1WLfoTyidHOX-sz_UpWj1sylbDtit8kmY/preview",
    tag: "Philosophy",
    featured: true,
  },
]
...
export const roles: Role[] = [
  {
    ...
    description:
      "Design and fabricate the awning and structural framework for Orble, an automated boba tea vending machine startup, using SolidWorks, laser cutting, 3D printing, and PVC fabrication.",
    category: "Technical",
  },
  {
    ...
    description:
      "Conduct research on the design and fabrication of insect wing-inspired morphing structures, drawing on principles of bio-inspired engineering and adaptive systems. Design and model bio-inspired morphing geometries using Rhino and Grasshopper.",
    category: "Technical",
  },
  {
    ...
    description:
      "Developed innovative solution to the limitation of radiation-resistant materials in HDPE composites to enhance material performance under lunar radiation conditions. Contributed to technical proposal development and NASA mission review process. Ranked top 6 proposal out of 40+ teams.",
    category: "Technical",
  },
  {
    ...
    description:
      "Led outreach initiatives and external partnerships to grow student engagement in astronomy programming. Secured $200 in external funding, developed telescope operation skills for weekly telescope observation nights, and coordinated cross-organizational events with campus groups.",
    category: "Leadership",
  },
  {
    ...
    org: "#MyStory Program",
    description:
      "Founded an initiative that aims to increase cultural awareness through a combination of oral history, narrative therapy, and portrait exhibition. Secured $24k+ through donations, fundraisers, and grant funding, including funding from Riley's Way Foundation, Prudential, Ashoka, and Peter&Elizabeth Tower Foundation. Collaborated with 20+ community partners and oversaw 40+ volunteers.",
    category: "Leadership",
  },
  {
    ...
    description:
      "Perform at athletics, alumni, and community events; engage large audiences through nonverbal communication, improvisation, and high-energy public engagement in fast-paced, high-visibility environments.",
    category: "Leadership",
  },
]
